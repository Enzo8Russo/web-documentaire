...
function getContentForFolder(folderName) {
  ...
  switch (folderName) {
    case 'Victime':
      return '<h2 style="color: #000;">La Victime :</h2><div style="padding: 50px; display: flex;align-items: center; justify-content: center;"><div style="text-align: center;"><img style="width: 30%; margin-bottom: 20px;" src="img/victime_1.jpg"><p style="color: #000;">Scene de crime<br><br><a href="img/victime_1.jpg" target="_BLANK">En Savoir Plus</a></p></div><div style="text-align: center;"><img style="width: 30%; margin-bottom: 20px;" src="img/victime_01.jpg"><p style="color: #000;">Identification de victime<br><br><a href="img/victime_01.jpg" target="_BLANK">En Savoir Plus</a></p></div></div>';
    case 'Temoignage':
      return '<h2 style="color: #000;">Liste Des Témoignages :</h2><div style="padding: 50px; display: flex;align-items: center; justify-content: center;"><div style="text-align: center;"><img style="width: 30%; margin-bottom: 20px;" src="img/temoignage_01.jpg"><p style="color: #000;">Témoignage anonyme 1<br><br><a href="img/temoignage_01.jpg" target="_BLANK">En Savoir Plus</a></p></div><div style="text-align: center;"><img style="width: 30%; margin-bottom: 20px;" src="img/temoignage_02.jpg"><p style="color: #000;">Témoignage anonyme 2<br><br><a href="img/temoignage_02.jpg" target="_BLANK">En Savoir Plus</a></p></div></div>';
